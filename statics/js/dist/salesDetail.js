define(["jquery", "print"], function(a, b, c) {
	function d() {
		...
		l("#filter-submit").on("click", function(a) {
			...
			a.preventDefault(), l("#filter-fromDate").val(n.beginDate), l("#filter-toDate").val(n.endDate), l("#filter-customer input").val(""), l("#filter-goods input").val(""), l("#filter-storage input").val(""),l("#filter-brand input").val(""), l("#filter-saler input").val(""), b.chkNot()
		})
	}
	function e() {
